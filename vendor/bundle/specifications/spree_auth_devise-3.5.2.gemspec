# -*- encoding: utf-8 -*-
# stub: spree_auth_devise 3.5.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<devise>.freeze, [">= 4.4", "< 4.7"])
      s.add_runtime_dependency(%q<devise-encryptable>.freeze, ["= 0.2.0"])
      s.add_runtime_dependency(%q<spree_core>.freeze, [">= 3.1.0", "< 4.0"])
      ...
      s.add_development_dependency(%q<spree_backend>.freeze, [">= 3.1.0", "< 4.0"])
      s.add_development_dependency(%q<spree_frontend>.freeze, [">= 3.1.0", "< 4.0"])
      s.add_development_dependency(%q<sqlite3>.freeze, [">= 0"])
      s.add_development_dependency(%q<appraisal>.freeze, [">= 0"])
    else
      s.add_dependency(%q<devise>.freeze, [">= 4.4", "< 4.7"])
      s.add_dependency(%q<devise-encryptable>.freeze, ["= 0.2.0"])
      s.add_dependency(%q<spree_core>.freeze, [">= 3.1.0", "< 4.0"])
      ...
      s.add_dependency(%q<spree_backend>.freeze, [">= 3.1.0", "< 4.0"])
      s.add_dependency(%q<spree_frontend>.freeze, [">= 3.1.0", "< 4.0"])
